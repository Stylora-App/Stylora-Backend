...
public static class ClothingTagTaxonomy
{
    public static string? NormalizeArticleType(string? articleType)
    {
        ...
        return normalized switch
        {
            ...
            _ when normalized.Contains("trench", StringComparison.OrdinalIgnoreCase) => "coat",
            ...
            _ when normalized.Contains("trainer", StringComparison.OrdinalIgnoreCase) => "sneakers",
            _ when normalized.Contains("loafer", StringComparison.OrdinalIgnoreCase) => "shoes",
            _ when normalized.Contains("derb", StringComparison.OrdinalIgnoreCase) => "shoes",
            ...
            _ when normalized.Contains("flat", StringComparison.OrdinalIgnoreCase) &&
                 !normalized.Contains("flatter", StringComparison.OrdinalIgnoreCase) => "flats",
            _ when normalized.Contains("polo", StringComparison.OrdinalIgnoreCase) => "polo",
            _ when normalized.Contains("tunic", StringComparison.OrdinalIgnoreCase) => "tunic",
            _ when normalized.Contains("kurta", StringComparison.OrdinalIgnoreCase) => "kurta",
            _ when normalized.Contains("sweater", StringComparison.OrdinalIgnoreCase) => "sweater",
            _ when normalized.Contains("jumper", StringComparison.OrdinalIgnoreCase) => "jumper",
            _ when normalized.Contains("knit", StringComparison.OrdinalIgnoreCase) => "jumper",
            _ when normalized.Contains("cami", StringComparison.OrdinalIgnoreCase) => "top",
            _ when normalized.Contains("bodysuit", StringComparison.OrdinalIgnoreCase) => "top",
            _ when normalized.Contains("chino", StringComparison.OrdinalIgnoreCase) => "trousers",
            _ when normalized.Contains("parka", StringComparison.OrdinalIgnoreCase) => "jacket",
            _ when normalized.Contains("shacket", StringComparison.OrdinalIgnoreCase) => "jacket",
            _ when normalized.Contains("overshirt", StringComparison.OrdinalIgnoreCase) => "jacket",
            _ when normalized.Contains("puffer", StringComparison.OrdinalIgnoreCase) => "jacket",
            _ when normalized.Contains("heel", StringComparison.OrdinalIgnoreCase) => "heels",
            _ when normalized.Contains("watch", StringComparison.OrdinalIgnoreCase) => "watch",
            _ when normalized.Contains("belt", StringComparison.OrdinalIgnoreCase) => "belt",
            _ when normalized.Contains("sunglasses", StringComparison.OrdinalIgnoreCase) => "sunglasses",
            _ when normalized.Contains("bag", StringComparison.OrdinalIgnoreCase) => "bag",
            _ when normalized.Contains("backpack", StringComparison.OrdinalIgnoreCase) => "bag",
            _ when normalized.Contains("crossbody", StringComparison.OrdinalIgnoreCase) => "bag",
            _ when normalized.Contains("tote", StringComparison.OrdinalIgnoreCase) => "bag",
            _ when normalized.Contains("purse", StringComparison.OrdinalIgnoreCase) => "bag",
            _ when normalized.Contains("scarf", StringComparison.OrdinalIgnoreCase) => "scarf",
            _ when normalized.Contains("jewel", StringComparison.OrdinalIgnoreCase) => "jewelry",
            _ when normalized.Contains("necklace", StringComparison.OrdinalIgnoreCase) => "jewelry",
            _ when normalized.Contains("bracelet", StringComparison.OrdinalIgnoreCase) => "jewelry",
            _ when normalized.Contains("earring", StringComparison.OrdinalIgnoreCase) => "jewelry",
            _ when normalized.Contains("top", StringComparison.OrdinalIgnoreCase) => "top",
            _ => normalized
        };
    }
    ...
    public static string? ResolveCategory(string? category, string? articleType)
    {
        ...
        return normalizedArticleType switch
        {
            ...
            "watch" or "bag" or "belt" or "sunglasses" or "cap" or "scarf" or "jewelry" => "accessories",
